...
BUILTIN_COMMANDS = [
    ...
    {"name": "privacy",         "command": "/privacy",         "description": "View or change privacy and data sharing settings", "mode": "meta",
     "prompt_template": None},
    {"name": "compact",          "command": "/compact",          "description": "Context compacts automatically — shows info", "mode": "meta",
     "prompt_template": None},
    {"name": "clear",            "command": "/clear",            "description": "Start a fresh branch from the current point", "mode": "meta",
     "prompt_template": None},
